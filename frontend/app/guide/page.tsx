...
const applicantSteps: Step[] = [
  ...
  { title: "ติดตามผลจาก AI", detail: "เปิดเมนูประวัติการสมัครเพื่อดูคะแนน AI เหตุผล และสถานะของแต่ละใบสมัคร", icon: FileSearch, images: [{ src: "/guide/application-history.png", alt: "หน้าประวัติการสมัครงาน", caption: "สถานะ คะแนน และเหตุผลจาก AI" }] },
]
        ...
        <main className="mx-auto max-w-7xl px-5 py-8 lg:px-8 lg:py-12">
          ...
          <div className="mt-8 grid gap-8 lg:grid-cols-[220px_minmax(0,1fr)]">
            ...
            <div className="space-y-8">
              ...
              <section id="tips" className="scroll-mt-6 rounded-3xl bg-amber-50 p-6 dark:bg-amber-950/25 sm:p-8"><div className="flex items-center gap-3"><span className="flex size-9 items-center justify-center rounded-xl bg-amber-400 text-amber-950"><Check className="size-5" /></span><h2 className="text-xl font-bold text-amber-950 dark:text-amber-100">ข้อควรรู้เพื่อให้ใช้งานราบรื่น</h2></div><ul className="mt-5 space-y-3 text-sm leading-6 text-amber-950/80 dark:text-amber-100/80"><li className="flex gap-3"><Check className="mt-1 size-4 shrink-0" />การสมัครงานต้องแนบทั้ง Resume และ Transcript ให้ครบ</li><li className="flex gap-3"><Check className="mt-1 size-4 shrink-0" />คะแนนและเหตุผลจาก AI เป็นข้อมูลช่วยพิจารณา ควรอ่านรายละเอียดประกอบเสมอ</li><li className="flex gap-3"><Check className="mt-1 size-4 shrink-0" />หากข้อมูลบัญชีเปลี่ยนไป ให้แก้ไขได้จากเมนูโปรไฟล์</li></ul></section>
