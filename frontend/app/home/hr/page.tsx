          ...
          <div className="space-y-8">
            <div className="space-y-6">
              ...
              <p className="text-pretty text-lg leading-relaxed text-muted-foreground">
                ...
                โดยใช้ปัญญาประดิษฐ์ในการวิเคราะห์ข้อมูลจากเรซูเม่ของผู้สมัครอย่างละเอียด
                ไม่ว่าจะเป็นทักษะทางเทคนิค ประสบการณ์การทำงาน ประวัติการศึกษา
                รวมไปถึงลักษณะการนำเสนอผลงานในรูปแบบ Storytelling
                เพื่อค้นหาจุดแข็งที่แท้จริงของผู้สมัคร
              </p>
            </div>
